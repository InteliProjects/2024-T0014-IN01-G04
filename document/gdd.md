...
<img src="../assets/imagensGdd/MetaSupply.png" width="100%">
<sup>Fonte: Material produzido pelos autores (2024)</sup>
</div>
...
Além disso, para que o jogador pudesse acessar o escritório, foi criado outro arquivo e uma nova classe foi instanciada, na qual possui os métodos create (figura 47), preload e update, que realiza as mesmas funções da classe da cidade. 
...
<img src="../assets/imagensGdd/ExemploResponsividade.png" width=100%">
...
<img src="../assets/imagensGdd/ExemploDialogoBot.png" width=100%">
...
<img src="../assets/imagensGdd/ExemploIndicadorCidade.png" width=100%">
...
<div align="center">
<sub> Quadro 11 - Teste de Jogabilidade 4 </sub>
</div>
...
<div align="center">
<sub> Quadro 12 - Teste de Jogabilidade 5 </sub>
</div>
...
O Meta Supply Game foi idealizado para simplificar o complexo processo de seleção de fornecedores da empresa Meta, tornando-o acessível e educativo aos colaboradores. Para alcançar essa meta, o grupo Metódicos, composto por Ana Eloisa Façanha, Daniel Augusto, Felipe Zillo, Gabriel Toledo, Gustavo Gonçalves e Larissa Temóteo, desenvolveu um método de aprendizado gamificado. Este método permite a compreensão de todas as etapas do processo de contratação de fornecedores. Desde o início do projeto, estabelecemos objetivos claros para criar um jogo de grande valor. Ao longo de 10 semanas, trabalhamos com afinco, a fim de assegurar o máximo de satisfação para os usuários.

**1 | Garantir que os usuários estejam curiosos e ativos em relação aos processos de forma a reduzir os riscos na contratação**

Como no objetivo inicial,  neste momento atual, o jogo apresenta características que o tornam envolvente, como trilha sonora e história impecável,  estimulando a curiosidade do usuário. Sendo assim, os usuários conseguem entreter-se  do início do jogo até o final das fases.

**2 | Garantir que o colaborador saiba o processo**

Com um objetivo bem definido, o processo de contratação no jogo é bastante semelhante ao da vida real, porém mais conciso. À medida que avança pelas fases, o jogador amplia seus conhecimentos sobre o que é esperado, o que contribui para uma experiência de aprendizado.
3 | Desconstruir a ideia que é um processo complicado e garantir um senso de responsabilidade
Por meio de um enredo descomplicado, o jogador pode assimilar todo o conteúdo presente no jogo, tal ponto fundamental para compreender o processo de contratação. Para assegurar que o colaborador tenha senso de responsabilidade, o jogo traz elementos da vida real, como documentos de RFP e contas bancárias. Dessa maneira, o Meta Supply Game realizou esta etapa com grande êxito.

**4 | Jogo de curta duração (15 minutos aproximadamente)**

O Meta Supply Game consiste em 9 fases. Por isso, concluir todas as etapas dentro de um período de 15 minutos representou um desafio desde o início de seu desenvolvimento. Ao longo do projeto, conseguimos reduzir significativamente o tempo necessário para completar o jogo, que inicialmente era de cerca de 30 minutos. No entanto, no momento atual, o tempo estimado para concluir todas as fases gira em torno de 20 minutos. Assim, continuamos trabalhando para que, eventualmente, o jogo possa ser concluído dentro do tempo previsto.

**5 | Interface prática de ser acessada com o máximo de inovação.**

O jogo oferece uma interface intuitiva que simplifica a navegação e utilização das funções para os usuários, cumprindo o objetivo inicial de tornar a experiência prática e eficaz. Sua inovação está evidente no método de aprendizagem otimizado, que garante uma curva de aprendizado suave e gratificante, destacando-se ainda pelo recurso do minimapa, que orienta os jogadores e aprimora sua imersão durante a exploração do mundo do jogo. Este sucesso vai além das expectativas iniciais, proporcionando uma experiência de jogo envolvente e inovadora. Contudo, ainda estamos refinando a interface do jogo através de recursos inclusivos, como áudios de descritivos de objetos e feedbacks sensoriais, como vibrações ao acertar ou errar um etapa, a fim de torná-lo mais acessível a todos. 

**6 | Utilizar cases de exemplo**

A trama do jogo se desenrola em torno do processo de seleção de um buffet para a festa de lançamento do Meta Quest. O jogador é encarregado de escolher um  dentre  os diversos fornecedores disponíveis. À medida que avança pelas fases, o player tem a oportunidade de compreender em profundidade como esse processo funciona, permitindo uma experiência muito similar à vida real. Sendo assim, podemos afirmar que obtivemos êxito nessa etapa, visto que o jogo acontece em torno de uma simulação do dia-a-dia da empresa.

**7 | O jogo pode ter uma opção em inglês, mas o português deve ser priorizado**

A versão atual do jogo está disponível apenas em português brasileiro (PT-BR), como exigido para o projeto. Reconhecemos a importância de incluir o idioma inglês para globalizá-lo. No entanto, este objetivo está atualmente em fase de desenvolvimento e está previsto para ser implementado nas próximas versões do jogo.

**8 | Ofertar tanto Mobile quanto para Computador**

Tornar o jogo executável tanto no celular quanto no computador é um objetivo essencial, pois amplia as formas de acesso ao jogo. Por enquanto, no "Minimum Viable Product" (Produto Mínimo Viável, em português), há somente a versão para o computador. 
Entretanto, esta funcionalidade ainda será implementada.

**9 | Possibilitar o compartilhamento da conclusão de fases do jogo.**

Compartilhar a conclusão de uma fase permite que os jogadores celebrem suas conquistas e recebam reconhecimento pelos seus esforços. Isso pode aumentar a motivação e o engajamento do jogador. Por isso, estipulamos esse objetivo para o jogo Meta Supply. Contudo, no modelo atual, o jogo ainda está passando por implementações a fim de conter tal requisito, sendo disponível em uma futura versão.

Em suma, o Meta Supply Game representa um esforço colaborativo do grupo Metódicos, visando simplificar o complexo processo de seleção de fornecedores da empresa Meta, proporcionando uma experiência acessível e educativa aos colaboradores. Ao longo de 10 semanas de desenvolvimento, estabelecemos objetivos claros e trabalhamos arduamente para atingi-los. Através de um método de aprendizado gamificado, conseguimos criar um jogo envolvente, que estimula a curiosidade dos jogadores e oferece uma experiência de aprendizado significativa. Conseguimos reduzir o tempo necessário para completar o jogo, refinamos sua interface para torná-la mais intuitiva e inovadora, e estamos trabalhando na inclusão de recursos para torná-lo mais acessível a todos. Ainda há expansões planejadas, como a disponibilização em inglês, implementação da possibilidade de compartilhar a conclusão das fases e reduzir ainda mais o tempo de conclusão do jogo. Com o Meta Supply Game, buscamos não apenas fornecer entretenimento, mas também promover o aprendizado e o desenvolvimento profissional dos colaboradores da empresa Meta.
